 ...
 */
export type mapToCommandFunc = (resourceType: string, commandName: CommandNames, commandRecord?: Record<string, any>) => IUpdateCommand | ICreateCommand | IDeleteCommand | null;
